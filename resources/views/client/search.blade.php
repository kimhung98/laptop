    ...
    <div class="container">
        <aside class="leftcate">
            <div id="product-list" data-cate="laptop" class="lstlaptop">
                <h3 style="color: red; font-weight: bold">Tìm kiếm cho từ khóa: "{{$key}}"</h3>

                <div class="cate mo-tl row">
                    @foreach($sanpham as $sp)
                        @if($sp->loaisp->theloai->id == 1 and $sp->chitiet)
                            <div class="col-6 col-md-3 owl-item" style="width: 239px; height: 400px; border: 1px solid #e3e3e3;">
                                <div>
                                    ...
                                    <div class="props">
                                        <span class="dotted">{{$sp->chitiet->RAM}}</span>
                                        <span class="dotted">{{$sp->chitiet->OCung}}</span>
                                    </div>
                                </div>
                                <div class="promotion">
