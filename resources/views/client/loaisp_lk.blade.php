            ...
            <div id="product-list" data-cate="laptop" class="lstlaptop">
                <div class="cate mo-tl row">
                    ...
                    @foreach($sanpham as $sp)
                        @if($sp->loaisp->theloai->id <> 1 and $loaisp->id == $sp->idLoaiSp)
                            <div class="col-6 col-md-3 owl-item" style="width: 239px; height: 350px; border: 1px solid #e3e3e3;">
                                <div>
