                            ...
                            <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                ...
                                @foreach($slide as $sd)
                                    <tr class="odd gradeX" align="center">
                                        ...
                                        <td>{{$sd->link}}</td>
                                        <td class="center"><a href="admin/slide/xoa/{{$sd->id}}"><i class="fas fa-trash-alt"></i>  Delete</a></td>
                                        <td class="center"><a href="admin/slide/sua/{{$sd->id}}"><i class="far fa-edit"></i>  Edit</a></td>
                                    </tr>
                                @endforeach
                                </tbody>
                            </table>
